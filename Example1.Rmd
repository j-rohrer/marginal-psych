...
ggsave("plots/fig3.png", width = 4, height = 3)
...
Instead of directly looking at congruence as the predictor of interest, it may be natural to think about the effects of shape (spikes vs. bubble), text (kiki vs. buba), and of their interaction.
This results in an alternative model specification.


```{r alternative}
alternative <- glmer(rt ~ Spikes*Kiki + (1 + Spikes*Kiki | pp),
                     data = dataMain,
                     family = Gamma(link = "log"))
