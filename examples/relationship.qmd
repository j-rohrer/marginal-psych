...
```{r}
#| include: false
mod_ord_brm <- readRDS(here("fits/relationship_ordinal_brm.rds"))
```
```{r}
avg_comparisons(mod_ord_brm, variables = "partner")
avg_comparisons(mod_ord_brm, variables = "partner", type = "link")
```
