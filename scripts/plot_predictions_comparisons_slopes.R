...
prediction_20000 <- predictions(mod, newdata = data.frame(sex = 1, alter = 35, einkommenj1 = 20000))$estimate


# Prediction: what if she earned twice as much
predictions(mod, newdata = data.frame(sex = 1, alter = 35, einkommenj1 = 40000))
# Store value for plotting
prediction_40000 <- predictions(mod, newdata = data.frame(sex = 1, alter = 35, einkommenj1 = 40000))$estimate

# Comparison: Compare these two predictions
comparisons(mod, newdata = data.frame(sex = 1, alter = 35, einkommenj1 = 20000),
...
# Store value for plotting
slope_20000 <- slopes(mod, newdata = data.frame(sex = 1, alter = 35, einkommenj1 = 20000),
                      variables = "einkommenj1")$estimate
...
hypothetical_woman <- data.frame(sex = 1, alter = 35, einkommenj1 = seq(from = 0, to = 80000, by = 10))
...
ggplot(data = hypothetical_woman, aes(x = einkommenj1, y = lebensz_org)) +
  ...
  geom_line() +
  # Comparison
  geom_segment(x = 20000, xend = 40000, y = prediction_20000, color = color_neutral, linetype = "dashed") +
  geom_segment(x = 40000, y = prediction_20000, yend = prediction_40000, color = color_comparison, linetype = "solid") +
  # Slope
  geom_segment(x = slope_range[1],
               xend = slope_range[2],
