...
mod <- lm(IMP_friends_Start ~ bs(age, df = 3) + sex + partner_any + bs(age, df = 3):partner_any + sex:partner_any, data = dat)

#mod_high <- lm(IMP_friends_Start ~ bs(age, df = 5) + sex + partner_any + bs(age, df = 3):partner_any + sex:partner_any, data = dat)

# full interaction?
#mod_flex <- lm(IMP_friends_Start ~ bs(age, df = 3)*sex*partner_any, data = dat)
