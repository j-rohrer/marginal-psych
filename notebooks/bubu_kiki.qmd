...
mod2_predictions$congruence <- c(1, 0, 0, 1)

plot_predictions(mod2, by = c("word", "shape"), gray = TRUE) +
    labs(x = "Displayed word",
         y = "Reaction time in seconds (95% CI)",
         shape = "Shape") +
    coord_cartesian(ylim = c(2.5, 4.5))
ggsave(here("plots/fig3c_marginal.png"), width = 3, height = 3)
...
ggplot(mod2_predictions, 
  ...
  labs(x = "Displayed word",
       ...
       shape = "Shape") +
  guides(color = "none") +
  scale_color_manual(values = c(color_comparison, color_prediction)) +
  coord_cartesian(ylim = c(2.5, 4.5))
ggsave(here("plots/fig3c_verbose.png"), width = 3, height = 3)
