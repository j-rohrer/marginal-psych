...
```{r}
avg_comparisons(mod2, variables = "shape", by = "word")
...
# HIER WEITER
# Restructure more nicely
# Add: g-computation, Frequentist versus Bayesian
...
<!-- m1 <- glmer( -->
<!--   reaction_time ~ Spikes + Kiki + Spikes:Kiki + -->
<!--     (1 + Spikes + Kiki + Spikes:Kiki | participant), -->
<!--   data = dat, -->
<!--   family = Gamma(link = "log")) -->
...
<!-- # Probably also do that g-computation thing Solomon suggested -->
